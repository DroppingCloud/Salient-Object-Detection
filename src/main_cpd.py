...
if __name__ == "__main__":
    hparams = {
        "root_dir": os.path.join(PROJECT_ROOT, "data", "ECSSD"),
        "image_folder": "images",
        "mask_folder": "masks",
        "pretrained": True,
        "val_ratio": 0.3,
    ...
    model = CPDResNet(pretrained=hparams["pretrained"]).to(hparams["device"])
    ...
    history = trainer.train(epochs=hparams["epochs"])
