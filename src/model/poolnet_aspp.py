...
class DeepPoolLayer(nn.Module):
    def __init__(self, k, k_out, need_x2, need_fuse):
        ...
        self.need_fuse = need_fuse          # 是否融合 skip / info

        # ASPP-like：用不同 dilation rate 的卷积捕获多尺度感受野
        dilations = [2, 4, 8]
    ...
    def forward(self, x, x_skip=None, x_info=None):
        ...
        # 融合 skip feature 和 GGF / PPM guidance feature
        if self.need_fuse:
